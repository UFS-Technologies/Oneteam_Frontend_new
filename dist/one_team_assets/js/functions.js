...
function changeTheme($theme, $style, $themeStylesheet, $init) {
    ...
    if ($theme === 'light') {
        $logo.attr('src', $mediaUrl + 'one_team_assets/images/logo.png');
        $body.find('.dt-login__content-inner .dt-brand__logo-img').attr('src', $mediaUrl + 'one_team_assets/images/logo.png');
        $body.removeClass('theme-dark').removeClass('theme-semidark');
        $themeStylesheet.href = $baseUrl + 'one_team_assets/css/default/theme-' + $theme + stylePath + rtlString + '.min.css';
    } else if ($theme === 'dark') {
        $logo.attr('src', $mediaUrl + 'one_team_assets/images/logo-white.png');
        $body.removeClass('theme-semidark').addClass('theme-dark');
        $themeStylesheet.href = $baseUrl + 'one_team_assets/css/default/theme-' + $theme + rtlString + '.min.css';
