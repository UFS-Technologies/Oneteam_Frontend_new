...
.select-user-block{ border-bottom: #666 solid 1px !important; width: 100% !important; border: none;    padding-top: 15px; }.
.section-user-block-ne{float: left;}
.sml-bx-sctn-usr{height: 400px; overflow-y: scroll;}
/*tab started*/
/* .mat-progress-spinner circle, .mat-spinner circle {stroke: #f4a19f !important;} */
.mat-progress-spinner circle, .mat-spinner circle {stroke: #49ade7 !important;}
.input-date-assmnt-tab-lead{width: 91% !important;}
.crect-input-accounts-section{border: none; border-bottom: #313131 solid 1px !important;}
.aligyn-crect-account-section-.acc-grop{ padding-bottom: 1.34375em;}
.for-width-date-tabs-accounts-.section{ margin-left: 0px !important; max-width: 96% !important;border-bottom: #666 solid 1px !important;}
.input-date-item-group-diary{border: none; border-bottom: #313131 solid 1px; width: 60%;}
.input-dropdown-item-group-diary{border: none; border-bottom: #313131 solid 1px; width:50%;}
.mat-field-date-box-section{ width:75%; display: inline-block !important;}
.margin-lh-rh-to-crect-textbox{padding-left: 0px !important; padding-right: 0px !important;}
.margin-to-crect-text-box-recipt{margin-top: 7px;}
.crect-down-nput-contra-new-sctn{ top: 3px;}
.nput-top-to-crect-recipt-voucher{top: -7px;}
