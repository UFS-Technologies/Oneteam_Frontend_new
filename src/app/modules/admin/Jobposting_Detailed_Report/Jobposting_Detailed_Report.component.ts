...
@Component({
selector: 'app-Jobposting_Detailed_Report',
templateUrl: './Jobposting_Detailed_Report.component.html',
styleUrls: ['./Jobposting_Detailed_Report.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
export class Jobposting_Detailed_ReportComponent implements OnInit {
    EditIndex: number;
...
Page_Load()
{
    ...
    this.myInnerHeight = this.myInnerHeight - 255;
    this.Search_Jobposting_Detailed_Report();
}

Export()
{
    
        this.Student_Service_.exportExcel(this.Search_Jobposting_Detailed_Data,'Search Jobposting Detailed Report')
...
Search_Jobposting_Detailed_Report()
{
    debugger
   ...
   this.Total_Entries =0;
    ...
    this.issLoading = true;
    debugger
    this.Job_Posting_Service_.Search_Jobposting_Detailed_Report(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),Company_id_,Job_id_,this.Student_Status_,this.Blacklist_Status_,this.Activate_Status_,this.Fees_Status_).subscribe(Rows =>{
        debugger
        this.Search_Jobposting_Detailed_Data=Rows[0];


        for (var i=0;i<this.Search_Jobposting_Detailed_Data.length;i++)
        {
            if(this.Search_Jobposting_Detailed_Data[i].Placement_Status==1)
            {
                this.Search_Jobposting_Detailed_Data[i].Placement_Status_Name="Placed"
            }
            else (this.Search_Jobposting_Detailed_Data[i].Placement_Status_Name = "Not Placed");
            
        }

        for (var i=0;i<this.Search_Jobposting_Detailed_Data.length;i++)
        {
            if(this.Search_Jobposting_Detailed_Data[i].Interview_Status==1)
            {
                this.Search_Jobposting_Detailed_Data[i].Interview_Status_Name="Inteview Scheduled"
            }
            else (this.Search_Jobposting_Detailed_Data[i].Interview_Status_Name = "Inteview Not Scheduled");
        ...
        for (var i=0;i<this.Search_Jobposting_Detailed_Data.length;i++)
        {
            if(this.Search_Jobposting_Detailed_Data[i].Student_Status==1)
            {
                this.Search_Jobposting_Detailed_Data[i].Student_Status_Name="Notification Enable"
            }
            else (this.Search_Jobposting_Detailed_Data[i].Student_Status_Name = "Notification Disable");
        ...
        for (var i=0;i<this.Search_Jobposting_Detailed_Data.length;i++)
        {
            if(this.Search_Jobposting_Detailed_Data[i].Blacklist_Status==1)
            {
                this.Search_Jobposting_Detailed_Data[i].Blacklist_Status_Name="Blacklist"
            }
            else (this.Search_Jobposting_Detailed_Data[i].Blacklist_Status_Name = "Whitelist");
        ...
        for (var i=0;i<this.Search_Jobposting_Detailed_Data.length;i++)
        {
            if(this.Search_Jobposting_Detailed_Data[i].Fees_Status==1)
            {
                this.Search_Jobposting_Detailed_Data[i].Fees_Status_Name="Paid"
            }
            else (this.Search_Jobposting_Detailed_Data[i].Fees_Status_Name = "Payment Pending");
        ...
        for (var i=0;i<this.Search_Jobposting_Detailed_Data.length;i++)
        {
            if(this.Search_Jobposting_Detailed_Data[i].Activate_Status==1)
            {
                this.Search_Jobposting_Detailed_Data[i].Activate_Status_Name="Active"
            }
            else (this.Search_Jobposting_Detailed_Data[i].Activate_Status_Name = "Deactive");
        ...
        for (var i=0;i<this.Search_Jobposting_Detailed_Data.length;i++)
        {
            if(this.Search_Jobposting_Detailed_Data[i].Image_ResumeFilename==null||this.Search_Jobposting_Detailed_Data[i].Image_ResumeFilename==undefined||this.Search_Jobposting_Detailed_Data[i].Image_ResumeFilename=="")
            {
                this.Search_Jobposting_Detailed_Data[i].resume_button_view =0
            }
            else ( this.Search_Jobposting_Detailed_Data[i].resume_button_view =1);
