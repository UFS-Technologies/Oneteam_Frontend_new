...
Page_Load()
{
   ...
   this.Get_Menu_Status(10,this.Login_User);
...
Get_Menu_Status(Menu_id, Login_user_id)
{
    ...
    this.Qualification_Service_.Get_Menu_Status(Menu_id,Login_user_id).subscribe(Rows => {            
      this.array=Rows[0][0]
        ...
        if (Rows[0][0].View >0) 
        {
            ...
            if(Menu_id==10)
            {
                ...
                if(this.Permissions==undefined || this.Permissions==null)
                    ...
                    this.Qualification_Edit= this.array.Edit;
                    this.Qualification_Save= this.array.Save;
                    this.Qualification_Delete= this.array.Delete;
            }
