...
constructor(public GeneralFunctions_Service_:GeneralFunctions_Service ,public University_Service_:University_Service, private route: ActivatedRoute, private router: Router,public dialogBox: MatDialog) { }
ngOnInit() 
{
...
this.University_Service_.Search_University(this.University_Name_Search).subscribe(Rows => {
