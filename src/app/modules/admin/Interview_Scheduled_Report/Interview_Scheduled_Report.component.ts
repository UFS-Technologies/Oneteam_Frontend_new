...
@Component({
selector: 'app-Interview_Scheduled_Report',
templateUrl: './Interview_Scheduled_Report.component.html',
styleUrls: ['./Interview_Scheduled_Report.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
export class Interview_Scheduled_ReportComponent implements OnInit {
    EditIndex: number;
  ...
  Interview_Scheduled_Report_Data:any;
  Interview_Scheduled_Report_AppliedcountdetailsData:any;
  Interview_Scheduled_Report_Appliedcountdetails_Full_Data:any;
  Interview_Scheduled_Report_Appliedcountdetails_Placed_Data:any;
  Interview_Scheduled_Report_RejectedcountdetailsData:any;
...
ngOnInit() 
{
    ...
    this.Permissions = Get_Page_Permission(81);
...
Page_Load()
{
    ...
    this.Search_Interview_Scheduled_Summary();
}

Export()
{
    
        this.Student_Service_.exportExcel(this.Interview_Scheduled_Report_Data,'Jobposting Report')
...
Export_Rejectedcount_Data()
{
        ...
        this.Student_Service_.exportExcel(this.Interview_Scheduled_Report_RejectedcountdetailsData,'Jobposting Rejected Report')
...
Search_Interview_Scheduled_Summary()
{
   ...
   this.Total_Entries =0;
    ...
    this.Job_Posting_Service_.Search_Interview_Scheduled_Summary(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),Company_id_,
    Course_Id_
    ,this.Pointer_Start_,
    this.Pointer_Stop_,
    this.Page_Length_).subscribe(Rows =>{
       debugger
        this.Interview_Scheduled_Report_Data=Rows[0];
      
        this.Total_Entries =  this.Interview_Scheduled_Report_Data.length;
        // this.Jobs =  this.Interview_Scheduled_Report_Data.length;
        // this.Vacancies =  sum(0,this.Interview_Scheduled_Report_Data[i].No_Of_Vaccancy);

        let Vacancies = 0;

        for (let i = 0; i < this.Interview_Scheduled_Report_Data.length; i++) {
        //   Vacancies = sum(0,this.Interview_Scheduled_Report_Data[i].No_Of_Vaccancy);
          Vacancies = Number(Vacancies) + Number(this.Interview_Scheduled_Report_Data[i].No_Of_Vaccancy);
        }
    ...
    this.issLoading = false;
    if(this.Interview_Scheduled_Report_Data.length==0)
    { 
    this.issLoading=false;
...
Next_Click() {
    ...
    if (this.Interview_Scheduled_Report_Data.length == this.Page_Length_) {
...
Show_interview_Scheduled(status_id)
{
    ...
    // 
    // this.Interview_Scheduled_Report_AppliedcountdetailsData=[];
    // for (var i=0;i<this.Interview_Scheduled_Report_Appliedcountdetails_Full_Data.length;i++)
    // {
    //     if(this.Interview_Scheduled_Report_Appliedcountdetails_Full_Data[i].Interview_Status==status_id)
    //     {
    //         this.Interview_Scheduled_Report_AppliedcountdetailsData.push(this.Interview_Scheduled_Report_Appliedcountdetails_Full_Data[i])
    //     }
    // }
}
...
Show_Placement_Scheduled(placement_status)
{
    ...
    // this.Interview_Scheduled_Report_AppliedcountdetailsData=[];
    // for (var i=0;i<this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data.length;i++)
    // {
    //             if(this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Placement_Status==placement_status || placement_status ==-1
    //     )  
    //         this.Interview_Scheduled_Report_AppliedcountdetailsData.push(this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i])
    //     }
    // }
}
...
Show_Placement_Interview_Scheduled(placement_status, Interview_Status,inteview_attending_status)
{
    ...
    for (var i=0;i<this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data.length;i++)
    {
        ...
        // if(this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Placement_Status==placement_status)
        if((this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Placement_Status==placement_status || placement_status ==-1
        ) && (this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Interview_Status==Interview_Status || Interview_Status ==-1)
        && (this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Interview_Attending_Rejecting==inteview_attending_status || inteview_attending_status ==0)
            )
        {
            this.Interview_Scheduled_Report_AppliedcountdetailsData.push(this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i])
        }
...
//         if((this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Placement_Status==placement_status || placement_status ==-1
//         ) && (this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Interview_Status==Interview_Status || Interview_Status ==-1)
//         && (this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i].Interview_Status==inteview_attending_status || inteview_attending_status ==-1)
//             )
//         {
//             this.Interview_Scheduled_Report_AppliedcountdetailsData.push(this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data[i])
//         }
...
Search_Appliedcount_Details(JobPostingId,JobTitle,Company_Name)
{
    ...
    this.Job_Posting_Service_.Search_Appliedcount_Details(JobPostingId,JobTitle).subscribe(Rows =>{
        this.Interview_Scheduled_Report_AppliedcountdetailsData=Rows[0];
        
        for (var i=0;i<this.Interview_Scheduled_Report_AppliedcountdetailsData.length;i++)
        {
            if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Placement_Status==1)
            {
                this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Placement_Status_Name="Placed"
            }
            else (this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Placement_Status_Name = "Not Placed");
            
        }

        for (var i=0;i<this.Interview_Scheduled_Report_AppliedcountdetailsData.length;i++)
        {
            if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Status==1)
            {
                this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Status_Name="Inteview Scheduled"
            }
            else (this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Status_Name = "Inteview Not Scheduled");
        ...
        // for (var i=0;i<this.Interview_Scheduled_Report_AppliedcountdetailsData.length;i++)
        // {
        //     if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Attending_Rejecting==1)
        //     {
        //         this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Attending_Rejecting_Name="Inteview Apply"
        //     }
        //     if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Attending_Rejecting==2)
        //     {
        //         this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Attending_Rejecting_Name="Inteview Reject"
        //     }
        //     if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Attending_Rejecting==3)
        //     {
        //         this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Interview_Attending_Rejecting_Name="Not Responded"
        //     }
        // }
        ...
        for (var i=0;i<this.Interview_Scheduled_Report_AppliedcountdetailsData.length;i++)
        {
            if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename==null||this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename==undefined||this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename=="")
            {
                this.Interview_Scheduled_Report_AppliedcountdetailsData[i].resume_button_view =0
            }
            else ( this.Interview_Scheduled_Report_AppliedcountdetailsData[i].resume_button_view =1);
...
for (var i = 0; i < this.Interview_Scheduled_Report_AppliedcountdetailsData.length; i++) {
  var data = this.Interview_Scheduled_Report_AppliedcountdetailsData[i];
  var selectedData = {
...
debugger
        this.Interview_Scheduled_Report_Appliedcountdetails_Full_Data=Rows[0];
        this.Interview_Scheduled_Report_Appliedcountdetails_Placed_Data=Rows[0];
        
        this.Search_Job = JobTitle
        this.Search_Company = Company_Name
        this.Total_Entries_Appliedcount =this.Interview_Scheduled_Report_AppliedcountdetailsData.length;
       
    this.issLoading = false;
    if(this.Interview_Scheduled_Report_AppliedcountdetailsData.length==0)
    { 
    this.issLoading=false;
    const dialogRef = this.dialogBox.open( DialogBox_Component, {panelClass:'Dialogbox-Class',data:{Message:'No Details Found',Type:"3"}});
    }
...
Search_Rejectedcount_Details(JobPostingIdrejected,JobTitleRejected)
{
    ...
    this.Job_Posting_Service_.Search_Rejectedcount_Details(JobPostingIdrejected,JobTitleRejected).subscribe(Rows =>{
        this.Interview_Scheduled_Report_RejectedcountdetailsData=Rows[0];
       
        this.Search_Job = JobTitleRejected
        this.Total_Entries_Rejectedcount =this.Interview_Scheduled_Report_RejectedcountdetailsData.length;
       
    this.issLoading = false;
    if(this.Interview_Scheduled_Report_RejectedcountdetailsData.length==0)
    { 
    this.issLoading=false;
    const dialogRef = this.dialogBox.open( DialogBox_Component, {panelClass:'Dialogbox-Class',data:{Message:'No Details Found',Type:"3"}});
    }
...
Download_Resume_File(File_Name,StudentId) {
    ...
    // for (var i=0;i<this.Interview_Scheduled_Report_AppliedcountdetailsData.length;i++)
    // {
        File_Name_Temp=this.Interview_Scheduled_Report_AppliedcountdetailsData.Image_ResumeFilename;  
    // }
...
for (var i=0;i<this.Interview_Scheduled_Report_RejectedcountdetailsData.length;i++)
{
    File_Name_Temp=this.Interview_Scheduled_Report_RejectedcountdetailsData[0].Image_ResumeFilename;  
}
...
{
    debugger
    for(var i=0;i<this.Interview_Scheduled_Details_Data.length;i++)
    {
        if(this.select_Resume==false)
            this.Interview_Scheduled_Details_Data[i].Check_Box=true;
        else
            this.Interview_Scheduled_Details_Data[i].Check_Box=false;
    }
...
//     
//     //  this.issLoading =true;
//     // this.Interview_Scheduled_Report_AppliedcountdetailsData=this.Job_Posting_Data_List[index_].Interview_Scheduled_Report_AppliedcountdetailsData;
//     var selectioncount=0;
//         for(var i=0;i<this.Interview_Scheduled_Report_AppliedcountdetailsData.length;i++)
//           if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Check_Box==true)
//             {
//               selectioncount=1;
//               break;
//             }
...
//             this.files.push({'filename':environment.FilePath + this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename,'Originalfilename':this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename})
//             // tempfile_size=tempfile_size+Number(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Album_Id) ;   "http://oneteamdemo.trackbox.co.in/bina/Uploads/"
//           }
//         }
   ...
   for(var i=0;i<ar.length;i++)
       ...
       for(var i=0;i<this.Interview_Scheduled_Report_AppliedcountdetailsData.length;i++)
       {
         if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Check_Box==true)
         {
           ...
           //this.files.push({'filename':environment.FilePath + this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename,'Originalfilename':this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename})
           this.files.push({
               filename: environment.FilePath + this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename,
               Originalfilename: this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename,
             });
    ...
    //    for (var i = 0; i < this.Interview_Scheduled_Report_AppliedcountdetailsData.length; i++) {
    //     if (this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Check_Box == true) {
    //       const fileWithExtension = this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Image_ResumeFilename;
...
Schedule_Interview()
{
    ...
    for(var i=0;i<this.Interview_Scheduled_Details_Data.length;i++)
      if(this.Interview_Scheduled_Details_Data[i].Check_Box==true)
        {
          selectioncount=1;
          break;
        }
...
// if(this.Interview_Scheduled_Details_Data[i].Check_Box==true)
// {
//     if(this.Interview_Scheduled_Details_Data[i].Interview_Status==1)
//         {
...
//           if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Check_Box==true)
//           {
//             temp_Applied_jobs=temp_Applied_jobs + this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Applied_Jobs_Id + ','
//           }
//         }
...
//               if(this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Check_Box==true)
//               {
//                 temp_Student_d=temp_Student_d + this.Interview_Scheduled_Report_AppliedcountdetailsData[i].Student_Id + ','
//               }
//             }
...
Save_Schedule_Interview()
{
 ...
 debugger
    ...
    for(var i=0;i<this.Interview_Scheduled_Details_Data.length;i++)
        {
          if(this.Interview_Scheduled_Details_Data[i].Check_Box==true)
          {
            temp_Applied_jobs=temp_Applied_jobs + this.Interview_Scheduled_Details_Data[i].Applied_Jobs_Id + ','
          }
        }
        temp_Applied_jobs=temp_Applied_jobs.substring(0,temp_Applied_jobs.length-1)
        ...
        for(var i=0;i<this.Interview_Scheduled_Details_Data.length;i++)
            {
              if(this.Interview_Scheduled_Details_Data[i].Check_Box==true)
              {
                temp_Student_d=temp_Student_d + this.Interview_Scheduled_Details_Data[i].Student_Id + ','
              }
            }
            temp_Student_d=temp_Student_d.substring(0,temp_Student_d.length-1)
    ...
    this.Interview_Schedule_.Login_User =  this.Login_User;
    this.Interview_Schedule_.Student_Id =  temp_Student_d;
    this.Interview_Schedule_.Job_Id = this.Job_Id_Interview;
 ...
 this.issLoading = true;
    this.Job_Posting_Service_.Save_ReSchedule_Interview(this.Interview_Schedule_).subscribe(Save_status => {
        debugger
   ...
   this.Total_Entries =0;
    ...
    this.Job_Posting_Service_.Search_Interview_Scheduled_Details(Job_id_,Company_Id,Interview_Date,Interview_Time,course_id).subscribe(Rows =>{
       debugger
        ...
        this.Total_Entries_Appliedcount =  this.Interview_Scheduled_Details_Data.length;
