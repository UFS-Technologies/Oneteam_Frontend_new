...
@Component({
selector: 'app-Placed_Report',
templateUrl: './Placed_Report.component.html',
styleUrls: ['./Placed_Report.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
export class Placed_ReportComponent implements OnInit {
    EditIndex: number;
    ...
    issLoading: boolean;
    Permissions: any;
    Placed_Report_Edit:boolean;
    Placed_Report_Save:boolean;
    Placed_Report_Delete:boolean;
    ...
    Login_User: number = 0;
    Placed_Report_EditIndex: number = -1;
...
ngOnInit() 
{
    ...
    {
    this.Placed_Report_Edit=this.Permissions.Edit;
    this.Placed_Report_Save=this.Permissions.Save;
    this.Placed_Report_Delete=this.Permissions.Delete;
    this.Page_Load()
...
Export()
{
        ...
        this.Student_Service_.exportExcel(this.Placed_Report_Master_Data,'Placement Report')
...
Search_Placed_Report()
{
    ...
    this.issLoading = true;
    this.Student_Service_.Search_Placed_Report(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),Course_Id,SearchEmployer_Details_Id,this.Login_User).subscribe(Rows =>{
