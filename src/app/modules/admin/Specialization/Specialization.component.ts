...
Delete_Specialization(Specialization_Id,index)
{
    ...
    if(result=='Yes')
        {
        this.issLoading=true;
        this.Specialization_Service_.Delete_Specialization(Specialization_Id).subscribe(Delete_Specialization => {
        
        Delete_Specialization = Delete_Specialization[0];
        Delete_Specialization = Delete_Specialization[0].DeleteStatus_.data[0];
        if(Delete_Specialization==1){
