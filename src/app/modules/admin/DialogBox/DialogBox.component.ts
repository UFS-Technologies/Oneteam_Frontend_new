...
export class DialogBox_Component implements OnInit {
  ...
  constructor(
    ...
    if (this.showNo == "false" || this.showNo == "False") {
      this.NoButton = "No";
      this.YesButton = "OK";
      this.Image_Url='/one_team_assets/img/Green_Tick.png';
      this.show=false;
    }
    else if(this.showNo == "true" ||this.showNo == "True") {
      this.NoButton = "No";
      this.YesButton = "Yes";
      this.Image_Url='/one_team_assets/img/Question_Mark.png';
      this.show=true;
    }
    else if(this.showNo == "2" )
    {
      this.NoButton = "No";
      this.YesButton = "OK";
      this.Image_Url='/one_team_assets/img/Red_Into.png';
      this.show=false;
    }
    else if(this.showNo == "3" )
    {
      this.NoButton = "No";
      this.YesButton = "OK";
      this.Image_Url='/one_team_assets/img/White_Img.png';
      this.show=false;
    }
