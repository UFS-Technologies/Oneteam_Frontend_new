...
@Component({
selector: 'app-Fees_Outstanding_Report',
templateUrl: './Fees_Outstanding_Report.component.html',
styleUrls: ['./Fees_Outstanding_Report.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
export class Fees_Outstanding_ReportComponent implements OnInit {
    EditIndex: number;
...
Page_Load()
{
    ...
    this.Is_Date=true;
    this.Search_Fees_Outstanding_Report();
    this.myInnerHeight = (window.innerHeight);
...
Search_Fees_Outstanding_Report()
{
    ...
    this.issLoading = true;
    debugger
    this.Student_Service_.Search_Fees_Outstanding_Report(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),Course_Id,Batch_Id,search_name_,this.Login_User,Team_Member_Selection).subscribe(Rows =>{
        debugger
