...
return body || { };
    ...
    Save_Candidate(Main_Array, ImageFile_Photo: File[],ImageFile_Resume: File[]) {
...
Search_Applied_Candidate(From_Date,To_Date,Candidate_Search): Observable<any>
{
    var Search_Data = { 'From_Date':From_Date,'To_Date':To_Date,'Candidate_Search': Candidate_Search }
